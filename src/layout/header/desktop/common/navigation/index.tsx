                        ...
                        {menuItem.subMenuItems.map((subMenuItem, index) => (
                          <li key={index} className="leading-none">
                            <CustomLink
                              href={subMenuItem.href}
                              openNewTab={subMenuItem.openNewTab}
                              className="flex min-h-[40px] items-center  px-4  text-[15px] font-normal capitalize text-black transition-colors duration-200 hover:underline hover:decoration-primary  dark:text-white"
                            >
                              {subMenuItem.label}
                            </CustomLink>
                          </li>
