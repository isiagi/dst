    ...
    subsections: [
      {
        ...
        text: 'We monitor your systems 24/7, using advanced tools to detect, isolate, and stop threats before they cause harm.',
      },
      {
        heading: 'Identity & Access Management',
        text: 'Control who can access sensitive data and systems with strong authentication and user-role policies.',
      },
      {
        heading: 'Incident Response',
        text: 'When a breach occurs, speed matters. We help you contain, investigate, and recover with minimal disruption.',
      },
      {
        heading: 'Compliance Support',
        text: 'We help you meet cybersecurity standards like HIPAA, PCI-DSS, and SOC 2 to keep you audit-ready and secure.',
      },
    ],
    imageEnd:
      'https://plus.unsplash.com/premium_photo-1674669009418-2643aa58b11b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Y3liZXJzZWN1cml0eXxlbnwwfHwwfHx8MA%3D%3D',
    ...
    subsections: [
      {
        ...
        text: 'We monitor and optimize your infrastructure to prevent downtime and ensure smooth performance.',
      },
      {
        heading: 'IT Helpdesk Support',
        text: 'Fast, friendly help when you need it—from troubleshooting to day-to-day technical issues.',
      },
      {
        heading: 'Backup & Disaster Recovery',
        text: 'We protect your data with secure backups and recovery plans to ensure business continuity.',
      },
      {
        heading: 'IT Consulting',
        text: 'Our experts guide you in aligning IT strategies with your business goals for long-term success.',
      },
    ],
    imageEnd:
      'https://images.unsplash.com/photo-1532102235608-dc8fc689c9ab?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8bWFuYWdlZCUyMHNlcnZpY2VzfGVufDB8fDB8fHww',
    ...
    subsections: [
      {
        ...
        text: 'Centralize your data into structured systems that are easy to access, query, and manage.',
      },
      {
        heading: 'Data Visualization',
        text: 'See your data come to life with dashboards, charts, and reports that highlight what matters most.',
      },
      {
        heading: 'Predictive Analytics',
        text: 'Leverage machine learning and statistics to forecast trends and stay ahead of the curve.',
      },
      {
        heading: 'Business Intelligence (BI)',
        text: 'We connect the dots across departments, giving leadership the insights they need to take action.',
      },
    ],
    imageEnd:
      'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8ZGF0YXxlbnwwfHwwfHx8MA%3D%3D',
    ...
    subsections: [
      {
        ...
        text: 'From mobile to enterprise apps, we build solutions tailored to your specific needs and users.',
      },
      {
        heading: 'Software Integration',
        text: 'We connect your existing tools and platforms to improve efficiency and data consistency.',
      },
      {
        heading: 'Industry-Specific Solutions',
        text: 'We develop specialized systems for industries like healthcare, finance, and retail.',
      },
      {
        heading: 'Agile Delivery',
        text: 'With Scrum and Agile methods, we ensure rapid development, transparency, and adaptability.',
      },
    ],
    imageEnd:
      'https://plus.unsplash.com/premium_photo-1678565869434-c81195861939?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fHNvZnR3YXJlfGVufDB8fDB8fHww',
